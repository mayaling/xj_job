...
// import Send from '../../jsAppInteractive/index1.js'
...
export default {
	...
	methods: {
		...
		checkapp() {
			...
			// var _this = this
			// alert(222)
			// this.$bridge.callhandler('webviewLoginSync', (data) => {
			// 	alert("webviewLoginSync")
			// 	alert(data)
			// // 处理返回数据
			// })
			// _this.JsBridge.callHandler(
			// 	'webviewLoginSync'
			// )
			...
			// 	''
			// )
			// Send.webviewLoginSync('webviewLoginSync')
			// alert(222)
            ...
            //     bridge.callHandler('webviewLoginSync',data,function(resp){
			// 		alert(222)
